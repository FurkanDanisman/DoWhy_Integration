...
class CausalEstimator:
    ...
    def _estimate_effect(self):
        ...
        raise NotImplementedError(
            ("Main estimation method is " + CausalEstimator.DEFAULT_NOTIMPLEMENTEDERROR_MSG).format(
                self.__class__
            )
        )
    ...
    def _do(self, x, data_df=None):
        raise NotImplementedError(
            ("Do-operator is " + CausalEstimator.DEFAULT_NOTIMPLEMENTEDERROR_MSG).format(
                self.__class__
            )
        )
    ...
    def construct_symbolic_estimator(self, estimand):
        raise NotImplementedError(
            (
                "Symbolic estimator string is " + CausalEstimator.DEFAULT_NOTIMPLEMENTEDERROR_MSG
            ).format(self.__class__)
        )
    ...
    def _estimate_confidence_intervals_with_bootstrap(
        ...
        bootstrap_variations = [
            bootstrap_estimate - estimate_value for bootstrap_estimate in bootstrap_estimates
        ]
