...
class CausalProofFinder:
    ...
    def _find_proof_single(self, start_expr, target_expr) -> Optional[List[Tuple[str, CausalProbability]]]:
        """
    ...
    def explore_all_equivalent_expressions(self, start_expr, max_depth: Optional[int] = None) -> Dict[str, Tuple[CausalProbability, str]]:
        """
